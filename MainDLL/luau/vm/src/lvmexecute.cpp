 ...
 */
#if VM_USE_CGOTO
#define VM_CASE(op) CASE_##((op * 227) & 0xFF):
...
#else
#define VM_CASE(op) case ((op * 227) & 0xFF):
...
{
    return op == ((LOP_PREPVARARGS * 227) & 0xFF) || op == ((LOP_BREAK * 227) & 0xFF);
}
...
#endif
        {
            ...
            VM_CASE(LOP_NEWCLOSURE)
            {
                ...
                for (int ui = 0; ui < pv->nups; ++ui)
                {
                    ...
                    LUAU_ASSERT(LUAU_INSN_OP(uinsn) == ((LOP_CAPTURE * 227) & 0xFF));
            ...
            VM_CASE(LOP_NAMECALL)
            {
                ...
                LUAU_ASSERT(LUAU_INSN_OP(*pc) == ((LOP_CALL * 227) & 0xFF));
            }
            ...
            VM_CASE(LOP_FASTCALL)
            {
                ...
                LUAU_ASSERT(LUAU_INSN_OP(call) == ((LOP_CALL * 227) & 0xFF));
            ...
            VM_CASE(LOP_BREAK)
            {
                ...
                LUAU_ASSERT(op != ((LOP_BREAK * 227) & 0xFF));
